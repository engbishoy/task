...
@section('pageHead')
<title>{{ __('category::header.title') }} | Sengine</title>
...
<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
    ...
    <!--begin::Title-->
    <h1 class="d-flex align-items-center fw-bolder fs-3 my-1 toolbar-main-title-color">{{ __('category::header.title') }}</h1>
    <!--end::Title-->
</div>
<!--end::Page title-->
@endsection
        ...
        <div class="card">
            ...
            <div id="header-container" class="card-header border-0 pt-6">
                ...
                <x-dashboard::dt-toolbar>
                    ...
                    <!--begin::Add-->
                    <x-dashboard::dt-add-btn dt-target="_datatable" data-action-url="{{ route('category.create') }}"/>
                    <!--end::Add-->

                    <!--begin::Trashed-->
                    <x-dashboard::dt-trash-btn dt-target="_datatable" data-action-url="{{ route('category.trashed.datatable') }}"/>
                    <!--end::Trashed-->

                    <!--begin::Previous-->
                    <x-dashboard::dt-prv-btn dt-target="_datatable" data-action-url="{{ route('category.datatable') }}"/>
                    <!--end::Previous-->
                    ...
                    <x-slot name="group">
                        ...
                        <x-dashboard::dt-actn-grp>
                            <x-dashboard::dt-actn-grp-delete data-action-url="{{ route('category.destroy.many') }}" />
                        </x-dashboard::dt-actn-grp>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <x-dashboard::dt-trashed-actn-grp>
                            <x-dashboard::dt-actn-grp-restore data-action-url="{{ route('category.trashed.restore.many') }}" />

                            <x-dashboard::dt-actn-grp-delete data-action-url="{{ route('category.trashed.destroy.many') }}" />
                        </x-dashboard::dt-trashed-actn-grp>
                        <!--end::Input group-->
                    </x-slot>
                    <!--end::Group actions-->
            ...
            <div class="card-body pt-0">
                <!--begin::Table-->
                <x-dashboard::data-table id="_datatable" data-url="{{ route('category.datatable') }}" 
                    data-order='[[ 1, "desc" ]]' data-page-length='25'>

                    <th>
                        {{ __('category::datatable.columns.name') }}
                    </th>
       
                    <th>
                        {{ __('category::datatable.columns.creation_date') }}
                    </th>
...
<script src="{{asset('/themes/metro8/assets/modules/category/js/category.js')}}"></script>
