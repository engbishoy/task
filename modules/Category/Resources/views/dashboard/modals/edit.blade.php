...
<form class="form fv-plugins-bootstrap5 fv-plugins-framework" method="post" id="dt_modal_form"
    ...
    <div class="modal-header custom-modal-header" id="kt_modal_add_customer_header">
        ...
        <div class="d-flex flex-shrink-0 p-1">
            <p class="main-modal-title"><span class="svg-icon svg-icon-2 me-2"><i class="far fa-edit fs-2"></span></i><span class="text-uppercase fs-3">{{ __('category::modal.edit-title') }}</span></p>
        </div>
        <!--end::Modal title-->
            ...
            <div id="errors-alert-wrapper" class="alert-wrapper d-none">
                <div class="alert alert-dismissible alert-danger d-flex align-items-center p-5 mb-10">
                    ...
                    <div class="d-flex flex-column">
                        <h4 class="mb-1 text-danger">{{ __('category::modal.form.errors') }}</h4>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="control-label required fs-6 mb-2">{{ __('category::modal.form.name-label') }}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                        <input type="text" class="form-control custom-form-control" placeholder="" name="name" value="{{$category->name}}">
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    </div>
    ...
    <div class="modal-footer flex-center">
        <!--begin::Button-->
        <button type="reset" id="dt_modal_cancel" class="btn btn-white me-3">{{ __('category::modal.form.cancel') }}</button>
        <!--end::Button-->
        <!--begin::Button-->
        <!-- Prevent implicit submission of the form -->
        <button type="submit" disabled style="display: none" aria-hidden="true"></button>
        <button type="submit" id="dt_modal_submit" class="btn btn-primary">
            <span class="indicator-label">{{ __('category::modal.form.submit') }}</span>
            <span class="indicator-progress">{{ __('category::modal.form.loading_submit') }}...
