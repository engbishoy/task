...
@section('pageHead')
<title>{{ __('product::header.title') }} | Sengine</title>
...
<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
    ...
    <!--begin::Title-->
    <h1 class="d-flex align-items-center fw-bolder fs-3 my-1 toolbar-main-title-color">{{ __('product::header.title') }}</h1>
    <!--end::Title-->
</div>
<!--end::Page title-->
@endsection
        ...
        <div class="card">
            ...
            <div id="header-container" class="card-header border-0 pt-6">
                ...
                <x-dashboard::dt-toolbar>
                    ...
                    <!--begin::Add-->
                    <x-dashboard::dt-add-btn dt-target="_datatable" data-action-url="{{ route('product.create') }}"/>
                    <!--end::Add-->

                    <!--begin::Trashed-->
                    <x-dashboard::dt-trash-btn dt-target="_datatable" data-action-url="{{ route('product.trashed.datatable') }}"/>
                    <!--end::Trashed-->

                    <!--begin::Previous-->
                    <x-dashboard::dt-prv-btn dt-target="_datatable" data-action-url="{{ route('product.datatable') }}"/>
                    <!--end::Previous-->
                    ...
                    <x-slot name="group">
                        ...
                        <x-dashboard::dt-actn-grp>
                            <x-dashboard::dt-actn-grp-delete data-action-url="{{ route('product.destroy.many') }}" />
                        </x-dashboard::dt-actn-grp>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <x-dashboard::dt-trashed-actn-grp>
                            <x-dashboard::dt-actn-grp-restore data-action-url="{{ route('product.trashed.restore.many') }}" />

                            <x-dashboard::dt-actn-grp-delete data-action-url="{{ route('product.trashed.destroy.many') }}" />
                        </x-dashboard::dt-trashed-actn-grp>
                        <!--end::Input group-->
                    </x-slot>
                    <!--end::Group actions-->
            ...
            <div class="card-body pt-0">
                <!--begin::Table-->
                <x-dashboard::data-table id="_datatable" data-url="{{ route('product.datatable') }}" 
                    data-order='[[ 1, "desc" ]]' data-page-length='25'>

                    <th>
                        {{ __('product::datatable.columns.photo') }}
                    </th>

                    <th>
                        {{ __('product::datatable.columns.name') }}
                    </th>
       

                    <th>
                        {{ __('product::datatable.columns.category') }}
                    </th>

                    <th>
                        {{ __('product::datatable.columns.creation_date') }}
                    </th>
...
<script src="{{asset('/themes/metro8/assets/modules/product/js/product.js')}}"></script>
